...
//   if (gCfg["ndmspc"]["data"]["map"]["enabled"].get<bool>()) fDataSource = DataSource::histogram;
// }
...
bool Results::LoadResults()
{
  ...
  // if (idBin < 0) {
  //   Printf("Could not find bin label '%s' in '%s' axis !!!", fParametesAxisName.c_str(),
  //   fCurrentParameterName.c_str()); return false;
  // }
  //
