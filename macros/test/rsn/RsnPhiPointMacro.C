  ...
  cfg = R"(
{
  "ndmspc": {
    "cuts": [],
    "data": {
      "file": "root://eos.ndmspc.io//eos/ndmspc/scratch/alice/hyperloop/PWGLF-376/192541/AnalysisResults.root",
      "directory":"phianalysis-t-hn-sparse_default",
      "objects": [
        "unlikepm:sigBg",
        "likepp+likemm:bgLike",
        "mixingpm+mixingmp:bgMixing",
        "unliketrue:mcTrue",
        "unlikegen:mcGen"
      ]
    },
    ...
    "result": {
      ...
      "axes": [
        { "name": "bg", "labels": ["like", "mixing"], "default": 0 },
        {
          "name": "norm",
          "ranges": [
            { "name": "normOne", "range": [0.99, 1.0] },
            { "name": "normTwo", "range": [1.05, 1.06] }
          ],
          "default": 0
        },
        {
          "name": "fitFun",
          "labels": ["VoigtPol1", "VoigtPol2"],
          "default": 1
        },
        {
          "name": "fitRange",
          "ranges": [{ "name": "frOne", "range": [0.997, 1.05] },{ "name": "frTwo", "range": [0.995, 1.06] }],
          "default": 0
        }
      ]
    },
