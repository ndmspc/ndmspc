...
NumcalResult NNumcalManager::RunVegas(const VegasIntegrator::VegasOptions & options) const
{
  ...
  NLogInfo("Vegas parameters: ndim=%d, epsrel=%e, epsabs=%e, seed=%d, mineval=%d, maxeval=%d, nstart=%d, nincrease=%d, "
           "nbatch=%d, gridno=%d, verbose=%d",
           options.ndim, options.epsrel, options.epsabs, options.seed, options.mineval, options.maxeval, options.nstart,
           options.nincrease, options.nbatch, options.gridno, options.verbose);
